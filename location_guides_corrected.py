...
#reference_aligned = open("ready_for_filter", "r")
out_temp = open("out","w")


#reference_aligned_read = reference_aligned.read()
#reference_read = reference.read()

#find the number of inserts compared to the ref after alignment
...
with open("ready_for_filter", "r") as reference_aligned:
...
pd.DataFrame.to_csv(guides, "adjusted_guides", index = False)
